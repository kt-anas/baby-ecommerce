    ...
    <footer className="py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Column 1 */}
          <div className=" ml-4 mb-4 flex  flex-col items-start justify-center">
        ...
        <div className="mb-4 flex items-center justify-center">
            <svg className="h-6 w-6 text-gray-600 mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <svg className="h-6 w-6 text-white-600 mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <svg className="h-6 w-6 text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
